...
def main(cfg):
    ...
    for iter in range(cfg.iteration):
        ...
        for i in range(len(all_rewards)):
            if all_rewards[i] == -float('inf') or i == best_sample_idx:
                all_rewards[i] = float('inf')
        ...
        best_content = best_policy + all_contents[best_sample_idx]
        ...
        # txt2 = worst_policy
        worst_content = worst_policy + all_contents[worst_sample_idx]
        ...
        iteration_messages3 = [{"role": "user", "content": code_feedback}]
        messages = global_messages + iteration_messages1 + iteration_messages2 + iteration_messages3
        #print("messages:", messages)
