...
def main(cfg):
    ...
    """
    todo: 1. 添加 cfg.threshold 到 initial_user 中
    """
    ...
    initial_system = initial_system.format(threshold=cfg.threshold, policy_signature=policy_signature, metric_description=metric_description, code_output_tip=code_output_tip)
