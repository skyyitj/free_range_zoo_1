...
class GenerateAgent(Agent):
    ...
    def act(self, action_space: free_range_rust.Space) -> List[List[int]]:
        ...
        for batch in range(self.parallel_envs):
            ...
            single_env_obs_self = self.observation['self'][batch]
            agent_pos = [single_env_obs_self[1], single_env_obs_self[0]]
            agent_fire_power = single_env_obs_self[2]
            agent_has_suppressant = single_env_obs_self[3]
