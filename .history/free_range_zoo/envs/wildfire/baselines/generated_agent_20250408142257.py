...
class GenerateAgent(Agent):
    ...
    def act(self, action_space: free_range_rust.Space) -> List[List[int]]:
        ...
        for batch in range(self.parallel_envs):
            ...
            agent_has_suppressant = int(agent_obs[3])
            ...
            print('other_agents_obs:', other_agents_obs)
            other_agents_pos = other_agents_obs[:, 0:2].tolist()
            other_agents_fire_power = other_agents_obs[:, 2]
            other_agents_suppressant = other_agents_obs[:, 3]
            print('other_agents_pos:', other_agents_pos)
            print('other_agents_fire_power:', other_agents_fire_power)
            print('other_agents_suppressant:', other_agents_suppressant)
            exit(0)
