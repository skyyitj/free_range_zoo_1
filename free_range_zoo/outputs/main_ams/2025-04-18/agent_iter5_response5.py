def single_agent_policy(
    ...
    for i, (fire_position, fire_level, fire_intensity, fire_weight) in enumerate(zip(fire_pos, fire_levels, fire_intensities, fire_putout_weight)):
        ...
        # Increase the weight of fire_weight to control Burning number and improve Rewards
        score = np.exp((3 * fire_weight * suppression_power / (dist + 1) + 2 * fire_level) / temperature)
