def single_agent_policy(
    ...
    dist_temperature = 0.03  # Lower distance temperature to put more focus on closer fires
    suppress_power_temperature = 0.2  # Increase suppression power temperature to put less stress on using suppressants
