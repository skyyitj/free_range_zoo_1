def single_agent_policy(
    ...
    dist_temperature = 0.1  # Lowered to reduce the effect of distance. Pickup nearest fires first.
    suppress_power_temperature = 0.02  # Increased to make suppressant power more significant.
    fire_level_temperature = 0.7  # Slightly decreased to make fire level slightly more important.
