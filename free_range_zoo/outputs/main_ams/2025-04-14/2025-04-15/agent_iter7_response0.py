...
def single_agent_policy(
    ...
    # Temperatures
    level_temperature = 0.45  # Increased temp to prioritize higher level fires
    intensity_temperature = 0.20  # Increased temp to disprioritize intense fires
    distance_temperature = 0.35  # Increased temp to prioritize nearby fires
