...
def single_agent_policy(
    ...
    level_temperature = 0.2  # Informed by focus need on fire_levels
    intensity_temperature = 0.005  # Informed by focus need on fire_intensities
    distance_temperature = 0.02  # Informed by focus need on fire_distance
...
# The updated policy has balanced temperature values to respond better to fires levels, intensity and distance. These temperatures are further refined and they control the contribution of each factor to the agent scoring system. I expect that this policy will result in better performance.