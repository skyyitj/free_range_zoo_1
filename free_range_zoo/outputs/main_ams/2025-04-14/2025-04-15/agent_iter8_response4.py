...
def single_agent_policy(
    ...
    # Temperatures
    level_temperature = 0.5 # increase level temperature
    intensity_temperature = 0.25 # increase intensity temperature
    distance_temperature = 0.1 # decrease distance temperature
