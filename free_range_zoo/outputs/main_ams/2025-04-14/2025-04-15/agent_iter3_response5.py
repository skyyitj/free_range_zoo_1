...
# The temperature parameters were reduced so that tasks with higher fire levels and intensities but further away are
# not overly prioritized. This allows agents to act more locally and potentially save more resources. Furthermore,
# tasks with high levels and intensities should not be overly prioritized if the agent does not have enough 
# suppressants to handle them, thus the division by 'can_put_out_fire' in the intensity term of the score calculation.