...
def single_agent_policy(
    ...
    intensity_temperature = 0.2 # Increased intensity temperature for weighing more on the intensity of the fire
    distance_temperature = 0.15 # Decreased distance temperature for weighing less on the location of the fire
