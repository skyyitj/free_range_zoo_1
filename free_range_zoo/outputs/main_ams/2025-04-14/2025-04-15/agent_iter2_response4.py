...
#I think the temperature parameters were varying too much hence decided to decrease them in order to reduce float point variations. This should make agent make decisions more steady and firm. Also, the decision will be more bias to the highest priority task.