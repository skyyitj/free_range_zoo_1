...
def single_agent_policy(
    ...
    # Increase suppressant efficiency factor
    suppressant_efficiency_factor = 3.0
    ...
    for i in range(num_fires):
        ...
        task_score = exp_distance * exp_intensity * exp_weight * (suppressant_efficiency_factor + agent_suppressant_num)
