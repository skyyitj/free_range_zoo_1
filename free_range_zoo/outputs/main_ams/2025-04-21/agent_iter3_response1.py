...
def single_agent_policy(
    ...
    # Adjusting temperature parameters based on the policy evaluation feedback
    distance_temp = 0.1
    intensity_temp = 1.0
    weight_temp = 2.0
    ...
    for i in range(num_fires):
        ...
        # After reviewing the feedback, we retain the factor of remaining suppressant at 1.5
        # which should effectively encourage better resource conservation
        task_score = exp_distance * exp_intensity * exp_weight * (1.5 + agent_suppressant_num)
        task_scores.append(task_score)

    # Return the index of the fire task with the maximum score
