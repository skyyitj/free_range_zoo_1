...
def single_agent_policy(
    ...
    for i in range(num_fires):
        ...
        # Added factor of remaining suppressant to encourage resource conservation
        task_score = exp_distance * exp_intensity * exp_weight * agent_fire_reduction_power * (1 + agent_suppressant_num)
