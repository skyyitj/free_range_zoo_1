def single_agent_policy(
    ...
    suppressant_conservation = agent_suppressant_num / np.max(potential_fire_reductions + 0.001)

    # Combine all scores to determine which fire to target
    # Incorporate fire importance, suppressant effectiveness directly, desperation inversely, and conservation
    scores = normalized_distances * np.array(fire_putout_weight) * suppressant_effectiveness * suppressant_conservation + fire_desperation
