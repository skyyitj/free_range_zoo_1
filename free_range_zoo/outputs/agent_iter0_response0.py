Here's the policy function for the agent. It will select the task of fire extinguishing based on an evaluation of all fires' intensity and level balanced with the position distance of the agent and other agents. It will also ensure that it has enough suppressant and retreats when resources are depleted.
